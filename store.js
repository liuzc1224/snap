...
SnapSerializer.prototype.rawLoadProjectModel = function (xmlNode) {
    ...
    // restore inheritance and nesting associations  恢复继承和嵌套关联
    myself.project.stage.children.forEach(function (sprite) {
        ...
        if (sprite.nestingInfo) { // only sprites may have nesting info  只有精灵可能有嵌套信息
    ...
    // clear sprites' inherited methods caches, if any  清除精灵的继承方法缓存，如果有的话
    myself.project.stage.children.forEach(function (sprite) {
